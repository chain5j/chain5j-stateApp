...
func NewStateTransition(evm *evm.EVM, msg models.VmMessage, gp *vm.GasPool) *StateTransition {
	st := &StateTransition{
		gp:       gp,
		vm:       evm,
		msg:      msg,
...
func ApplyMessage(evm *evm.EVM, msg models.VmMessage, gp *vm.GasPool) ([]byte, uint64, bool, error) {
